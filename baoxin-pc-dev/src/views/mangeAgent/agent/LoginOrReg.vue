  ...
  <div class="main-log">
    <div class="center clearfix">
      ...
      <div v-show="showLogin" class="login-warp out-container">
        ...
        <p class="toTeam">
           <router-link :to="{name:'LoginOrRegTeam'}">团队登陆<Icon type="md-arrow-forward" /></router-link>
        </p>
      </div>
          ...
          this.$axios({
            ...
            .then(result => {
              if (result.data.code == 0) {
                ...
                this.$store.commit("isLogin", { type: "agent", isLogin: true ,phone:this.formLogin.user});
                // 登陆成功后跳转顾问页面
                setTimeout(function(){
